...
const { abi, contractAddre } = require("./contants/index")
let chainId = process.env.chainId || 137
const contractAddress = contractAddre[chainId][0]
let moralisChainId = (chainId = "137" ? "137" : 137)
